        ...
        <section className="w-full py-20">
            <div className="container mx-auto px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="bg-white rounded-lg p-8">
                        ...
                        <div className="space-y-4">
                            <div>
                                <div className="text-5xl md:text-4xl font-bold text-[#003366]">2,000</div>
                                <div className="text-[#003366]/70 mt-2">MWp Total Capacity</div>
                            </div>
                            <div className="pt-4 border-t border-white/10">
                                <div className="text-2xl font-bold text-[#003366]">200</div>
                    ...
                    <div className="bg-white rounded-lg p-8">
                        ...
                        <div className="space-y-6">
                            <div className="flex items-end gap-4">
                                ...
                                <div className="flex-1">
                                    <div className="h-48 bg-[#003366]/50 rounded-lg relative">
                                        <div className="absolute bottom-2 left-0 right-0 text-center text-white">
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={index} className="group flex items-start gap-3">
                                    <div className="w-6 h-6 rounded-lg bg-[#003366]/50 flex items-center justify-center text-[#003366]">
                                        {index + 1}
                                    </div>
                                    <div>
                ...
                <div className="mt-16 max-w-3xl">
                    <p className="text-base text-[#003366]/70 leading-relaxed">
